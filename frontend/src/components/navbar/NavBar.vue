    ...
    <nav class="navbar w-full bg-base-100 shadow-sm">
      ...
      <div class="navbar-center w-4/5 max-w-180 flex justify-center">
        <div class="join w-4/5 flex justify-center">
          <input class="input join-item rounded-l-full" placeholder="Search What You Like" />
      ...
      <div class="navbar-end">
        ...
        <RouterLink v-if="user.isLogin()" :to="{name: 'update-character', params: {character_id: 9}}" active-class="menu-btn" class="btn btn-ghost text-base mr-6">
          <CreateIcon />
            Create
        </RouterLink>
